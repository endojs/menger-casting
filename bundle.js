...
var copy=require("copy-to-clipboard");document.addEventListener("keypress",function(e){if(99===e.keyCode){var r=document.querySelector("svg").innerHTML;copy('<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"> <svg width="521px" height="521px" version="1.1" baseProfile="full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ev="http://www.w3.org/2001/xml-events">'+r+"</svg>")}});var createViewer=require("../index"),viewer=createViewer({width:.4,height:.4,followMouse:!1,followMotion:!1,slowDrift:!0});document.body.appendChild(viewer.container),viewer.startAnimation();

},{"../index":2,"copy-to-clipboard":4}],2:[function(require,module,exports){
var perspective=require("gl-mat4/perspective"),multiply=require("gl-mat4/multiply"),lookAt=require("gl-mat4/lookAt"),invert=require("gl-mat4/invert"),rotate=require("gl-mat4/rotate"),transform=require("gl-vec3/transformMat4"),modelJSON=require("./model.json"),SVG_NS="http://www.w3.org/2000/svg";function createNode(t){return document.createElementNS(SVG_NS,t)}function setAttribute(t,e,n){t.setAttributeNS(null,e,n)}module.exports=function(t){var e=t||{},n=!!e.followMouse,o=!!e.slowDrift,r=!0,i=[0,0],a=.3,l=e.width||400,u=e.height||400,s=createNode("svg"),d={x:0,y:0},h=modelJSON.positions.length,c=new Float32Array(3*h),g=new Float32Array(3*h),w=[];function f(t){var e=s.getBoundingClientRect();d.x=1-15*(t.x-e.left)/e.width,d.y=1-15*(t.y-e.top)/e.height}function v(t,e){this.svg=t,this.indices=e,this.zIndex=0}e.pxNotRatio||(l=window.innerWidth*(e.width||.25)|0,u=0|(window.innerHeight*e.height||l),"minWidth"in e&&l<e.minWidth&&(l=e.minWidth,u=e.minWidth*e.height/e.width|0)),setAttribute(s,"width",l+"px"),setAttribute(s,"height",u+"px"),document.body.appendChild(s),function(){for(var t=modelJSON.positions,e=0,n=0;n<t.length;++n)for(var o=t[n],r=0;r<3;++r)c[e++]=o[r]}();var m=function(t=[]){console.log("generating polygons with colors: ",t);for(var e=[],n=0;n<modelJSON.chunks.length;++n){var o=modelJSON.chunks[n];console.log("otherwise falling back to ",o.color);var r="rgb("+(Boolean(t[n])?t[n]:o.color)+")";console.log(r);for(var i=o.faces,a=0;a<i.length;++a){var l=i[a],u=createNode("polygon");setAttribute(u,"fill",r),setAttribute(u,"stroke",r),setAttribute(u,"points","0,0, 10,0, 0,10"),s.appendChild(u),e.push(new v(u,l))}}return e},p=m(e.colors),A=function(){var t=new Float32Array(3),e=new Float32Array([0,1,0]),n=new Float32Array(16),r=new Float32Array(16),a=lookAt(new Float32Array(16),new Float32Array([0,0,400]),t,e),l=invert(new Float32Array(16),a),u=new Float32Array(16),d=new Float32Array(3),h=new Float32Array(16),c=new Float32Array([1,0,0]),g=new Float32Array([0,1,0]);new Float32Array([0,0,1]);return function(){var w=s.getBoundingClientRect(),f=w.width,v=w.height;if(perspective(n,Math.PI/100,f/v,100,1e3),invert(u,n),d[0]=i[0],d[1]=i[1],d[2]=1.2,transform(d,d,u),transform(d,d,l),lookAt(r,t,d,e),o){var m=Date.now()/1e3;rotate(r,r,2*Math.PI/3,c),rotate(r,r,m,g)}return multiply(h,n,a),multiply(h,h,r),h}}();function y(t,e){return e.zIndex-t.zIndex}function F(){r=!1}function x(){r=!0}function N(){if(r){window.requestAnimationFrame(N);var t=1-a;s.getBoundingClientRect();i[0]=t*i[0]+a*d.x,i[1]=t*i[1]+a*d.y+.085,!function(t){for(var e=t[0],n=t[1],o=t[2],r=t[3],i=t[4],a=t[5],l=t[6],u=t[7],s=t[8],d=t[9],w=t[10],f=t[11],v=t[12],m=t[13],p=t[14],A=t[15],y=0;y<h;++y){var F=c[3*y],x=c[3*y+1],N=c[3*y+2],b=F*r+x*u+N*f+A;g[3*y]=(F*e+x*i+N*s+v)/b,g[3*y+1]=(F*n+x*a+N*d+m)/b,g[3*y+2]=(F*o+x*l+N*w+p)/b}}(A()),function(t){var e,n=s.getBoundingClientRect(),o=n.width,r=n.height;for(w.length=0,t=t||p,e=0;e<t.length;++e){var i=t[e],a=i.indices,l=a[0],u=a[1],d=a[2],h=g[3*l],c=g[3*l+1],f=g[3*u],v=g[3*u+1],m=g[3*d];if(!((f-h)*(g[3*d+1]-c)-(v-c)*(m-h)<0)){for(var A=[],F=-1/0,x=1/0,N=i.svg,b=0;b<3;++b){var S=a[b];A.push(.5*o*(1-g[3*S])+","+.5*r*(1-g[3*S+1]));var k=g[3*S+2];F=Math.max(F,k),x=Math.min(x,k)}i.zIndex=F+.25*x;var M=A.join(" ");-1===M.indexOf("NaN")&&setAttribute(N,"points",M),w.push(i)}}for(w.sort(y),s.innerHTML="",e=0;e<w.length;++e)s.appendChild(w[e].svg)}(p),F()}}return window.addEventListener("mousemove",function(t){r||x(),n&&(f({x:t.clientX,y:t.clientY}),N())}),window.addEventListener("deviceorientation",function(t){if(r||x(),followMotion){const e=10;f({x:200+t.gamma*e,y:-200+t.beta*e}),N()}}),N(),{container:s,lookAt:f,setFollowMouse:function(t){n=t},stopAnimation:F,startAnimation:x,reRender:function(t){p=m(t),N()}}};
