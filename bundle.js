...
var copy=require("copy-to-clipboard");document.addEventListener("keypress",function(e){if(99===e.keyCode){var r=document.querySelector("svg").innerHTML;copy('<!DOCTYPE svg PUBLIC "-//W3C//DTD SVG 1.1//EN" "http://www.w3.org/Graphics/SVG/1.1/DTD/svg11.dtd"> <svg width="521px" height="521px" version="1.1" baseProfile="full" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ev="http://www.w3.org/2001/xml-events">'+r+"</svg>")}});var createViewer=require("../index"),viewer=createViewer({width:.4,height:.4,followMouse:!1,followMotion:!1});console.log(viewer),document.body.appendChild(viewer.container),viewer.spin(),viewer.startAnimation();

},{"../index":2,"copy-to-clipboard":4}],2:[function(require,module,exports){
var perspective=require("gl-mat4/perspective"),multiply=require("gl-mat4/multiply"),lookAt=require("gl-mat4/lookAt"),invert=require("gl-mat4/invert"),rotate=require("gl-mat4/rotate"),transform=require("gl-vec3/transformMat4"),modelJSON=require("./model.json"),SVG_NS="http://www.w3.org/2000/svg";function createNode(t){return document.createElementNS(SVG_NS,t)}function setAttribute(t,e,n){t.setAttributeNS(null,e,n)}module.exports=function(t){var e=t||{},n=!!e.followMouse,o=!!e.spinMode,r=!0,i=[0,0],a=.3,l=e.width||400,u=e.height||400,s=createNode("svg"),c={x:0,y:0},d=modelJSON.positions.length,h=new Float32Array(3*d),g=new Float32Array(3*d),f=[];function w(t){var e=s.getBoundingClientRect();c.x=1-15*(t.x-e.left)/e.width,c.y=1-15*(t.y-e.top)/e.height}function v(t,e){this.svg=t,this.indices=e,this.zIndex=0}e.pxNotRatio||(l=window.innerWidth*(e.width||.25)|0,u=0|(window.innerHeight*e.height||l),"minWidth"in e&&l<e.minWidth&&(l=e.minWidth,u=e.minWidth*e.height/e.width|0)),setAttribute(s,"width",l+"px"),setAttribute(s,"height",u+"px"),document.body.appendChild(s),function(){for(var t=modelJSON.positions,e=0,n=0;n<t.length;++n)for(var o=t[n],r=0;r<3;++r)h[e++]=o[r]}();var m=function(t=[]){console.log("generating polygons with colors: ",t);for(var e=[],n=0;n<modelJSON.chunks.length;++n){var o=modelJSON.chunks[n];console.log("otherwise falling back to ",o.color);var r="rgb("+(Boolean(t[n])?t[n]:o.color)+")";console.log(r);for(var i=o.faces,a=0;a<i.length;++a){var l=i[a],u=createNode("polygon");setAttribute(u,"fill",r),setAttribute(u,"stroke",r),setAttribute(u,"points","0,0, 10,0, 0,10"),s.appendChild(u),e.push(new v(u,l))}}return e},p=m(e.colors),A=function(){var t=new Float32Array(3),e=new Float32Array([0,1,0]),n=new Float32Array(16),r=new Float32Array(16),a=lookAt(new Float32Array(16),new Float32Array([0,0,400]),t,e),l=invert(new Float32Array(16),a),u=new Float32Array(16),c=new Float32Array(3),d=new Float32Array(16),h=new Float32Array([1,0,0]),g=(new Float32Array([0,1,0]),new Float32Array([0,0,1]));return function(){var f=s.getBoundingClientRect(),w=f.width,v=f.height;if(perspective(n,Math.PI/100,w/v,100,1e3),invert(u,n),c[0]=i[0],c[1]=i[1],c[2]=1.2,transform(c,c,u),transform(c,c,l),lookAt(r,t,c,e),o){var m=Date.now()/1e3;rotate(r,r,2*Math.PI/3,h),rotate(r,r,m/3,g)}return multiply(d,n,a),multiply(d,d,r),d}}();function y(t,e){return e.zIndex-t.zIndex}function F(){r=!0}function x(){if(r){window.requestAnimationFrame(x);var t=1-a;s.getBoundingClientRect();i[0]=t*i[0]+a*c.x,i[1]=t*i[1]+a*c.y+.085,!function(t){for(var e=t[0],n=t[1],o=t[2],r=t[3],i=t[4],a=t[5],l=t[6],u=t[7],s=t[8],c=t[9],f=t[10],w=t[11],v=t[12],m=t[13],p=t[14],A=t[15],y=0;y<d;++y){var F=h[3*y],x=h[3*y+1],N=h[3*y+2],b=F*r+x*u+N*w+A;g[3*y]=(F*e+x*i+N*s+v)/b,g[3*y+1]=(F*n+x*a+N*c+m)/b,g[3*y+2]=(F*o+x*l+N*f+p)/b}}(A()),function(t){var e,n=s.getBoundingClientRect(),o=n.width,r=n.height;for(f.length=0,t=t||p,e=0;e<t.length;++e){var i=t[e],a=i.indices,l=a[0],u=a[1],c=a[2],d=g[3*l],h=g[3*l+1],w=g[3*u],v=g[3*u+1],m=g[3*c];if(!((w-d)*(g[3*c+1]-h)-(v-h)*(m-d)<0)){for(var A=[],F=-1/0,x=1/0,N=i.svg,b=0;b<3;++b){var S=a[b];A.push(.5*o*(1-g[3*S])+","+.5*r*(1-g[3*S+1]));var M=g[3*S+2];F=Math.max(F,M),x=Math.min(x,M)}i.zIndex=F+.25*x;var k=A.join(" ");-1===k.indexOf("NaN")&&setAttribute(N,"points",k),f.push(i)}}for(f.sort(y),s.innerHTML="",e=0;e<f.length;++e)s.appendChild(f[e].svg)}(p)}}return window.addEventListener("mousemove",function(t){r||F(),n&&(w({x:t.clientX,y:t.clientY}),x())}),window.addEventListener("deviceorientation",function(t){if(r||F(),followMotion){const e=10;w({x:200+t.gamma*e,y:-200+t.beta*e}),x()}}),x(),{container:s,lookAt:w,setFollowMouse:function(t){n=t},stopAnimation:function(){r=!1},startAnimation:F,reRender:function(t){p=m(t),x()},spin:function(){return console.log("spinning"),o=!0,r=!0,x(),function(){r=!1,o=!1}}}};
