...
var perspective=require("gl-mat4/perspective"),multiply=require("gl-mat4/multiply"),lookAt=require("gl-mat4/lookAt"),invert=require("gl-mat4/invert"),rotate=require("gl-mat4/rotate"),transform=require("gl-vec3/transformMat4"),modelJSON=require("./model.json"),SVG_NS="http://www.w3.org/2000/svg";function createNode(t){return document.createElementNS(SVG_NS,t)}function setAttribute(t,e,n){t.setAttributeNS(null,e,n)}module.exports=function(t){var e=t||{},n=!!e.followMouse,o=!!e.slowDrift,r=!0,i=[0,0],a=.3,l=e.width||400,s=e.height||400,u=createNode("svg"),h={x:0,y:0},d=modelJSON.positions.length,c=new Float32Array(3*d),g=new Float32Array(3*d),f=[];function w(t){var e=u.getBoundingClientRect();h.x=1-15*(t.x-e.left)/e.width,h.y=1-15*(t.y-e.top)/e.height}function v(t,e){this.svg=t,this.indices=e,this.zIndex=0}e.pxNotRatio||(l=window.innerWidth*(e.width||.25)|0,s=0|(window.innerHeight*e.height||l),"minWidth"in e&&l<e.minWidth&&(l=e.minWidth,s=e.minWidth*e.height/e.width|0)),setAttribute(u,"width",l+"px"),setAttribute(u,"height",s+"px"),document.body.appendChild(u),function(){for(var t=modelJSON.positions,e=0,n=0;n<t.length;++n)for(var o=t[n],r=0;r<3;++r)c[e++]=o[r]}();var m=function(t=[]){console.log("generating polygons with colors: ",t);for(var e=[],n=0;n<modelJSON.chunks.length;++n){var o=modelJSON.chunks[n];console.log("otherwise falling back to ",o.color);var r="rgb("+(Boolean(t[n])?t[n]:o.color)+")";console.log(r);for(var i=o.faces,a=0;a<i.length;++a){var l=i[a],s=createNode("polygon");setAttribute(s,"fill",r),setAttribute(s,"stroke",r),setAttribute(s,"points","0,0, 10,0, 0,10"),u.appendChild(s),e.push(new v(s,l))}}return e},p=m(e.colors),A=function(){var t=new Float32Array(3),e=new Float32Array([0,1,0]),n=new Float32Array(16),r=new Float32Array(16),a=lookAt(new Float32Array(16),new Float32Array([0,0,400]),t,e),l=invert(new Float32Array(16),a),s=new Float32Array(16),h=new Float32Array(3),d=new Float32Array(16);new Float32Array([1,0,0]),new Float32Array([0,1,0]),new Float32Array([0,0,1]);return function(){var c=u.getBoundingClientRect(),g=c.width,f=c.height;if(perspective(n,Math.PI/100,g/f,100,1e3),invert(s,n),h[0]=i[0],h[1]=i[1],h[2]=1.2,transform(h,h,s),transform(h,h,l),lookAt(r,t,h,e),o){var w=Date.now()/1e3;Math.sin(w/3),Math.sin(w/2),Math.sin(w/3)}return multiply(d,n,a),multiply(d,d,r),d}}();function y(t,e){return e.zIndex-t.zIndex}function F(){r=!1}function x(){r=!0}window.addEventListener("mousemove",function(t){r||x(),n&&(w({x:t.clientX,y:t.clientY}),b())});function N(t){}function b(){if(r){window.requestAnimationFrame(b);var t=1-a;u.getBoundingClientRect();i[0]=t*i[0]+a*h.x,i[1]=t*i[1]+a*h.y+.085,!function(t){for(var e=t[0],n=t[1],o=t[2],r=t[3],i=t[4],a=t[5],l=t[6],s=t[7],u=t[8],h=t[9],f=t[10],w=t[11],v=t[12],m=t[13],p=t[14],A=t[15],y=0;y<d;++y){var F=c[3*y],x=c[3*y+1],N=c[3*y+2],b=F*r+x*s+N*w+A;g[3*y]=(F*e+x*i+N*u+v)/b,g[3*y+1]=(F*n+x*a+N*h+m)/b,g[3*y+2]=(F*o+x*l+N*f+p)/b}}(A()),function(t){var e,n=u.getBoundingClientRect(),o=n.width,r=n.height;for(f.length=0,t=t||p,e=0;e<t.length;++e){var i=t[e],a=i.indices,l=a[0],s=a[1],h=a[2],d=g[3*l],c=g[3*l+1],w=g[3*s],v=g[3*s+1],m=g[3*h];if(!((w-d)*(g[3*h+1]-c)-(v-c)*(m-d)<0)){for(var A=[],F=-1/0,x=1/0,N=i.svg,b=0;b<3;++b){var M=a[b];A.push(.5*o*(1-g[3*M])+","+.5*r*(1-g[3*M+1]));var S=g[3*M+2];F=Math.max(F,S),x=Math.min(x,S)}i.zIndex=F+.25*x;var k=A.join(" ");-1===k.indexOf("NaN")&&setAttribute(N,"points",k),f.push(i)}}for(f.sort(y),u.innerHTML="",e=0;e<f.length;++e)u.appendChild(f[e].svg)}(p),F()}}return window.addEventListener("deviceorientation",function(t){if(r||x(),followMotion){const e=10;w({x:200+t.gamma*e,y:-200+t.beta*e}),b()}}),b(),{container:u,lookAt:w,setFollowMouse:function(t){n=t},stopAnimation:F,startAnimation:x,reRender:function(t){p=m(t),b()},rotate:N}};
